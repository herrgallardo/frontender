...
import { ExperienceItem } from "@/lib/types/types"
...
const ExperienceTimeline: React.FC<ExperienceTimelineProps> = ({
  ...
  return (
    <div>
      {/* Use separate h2 elements - one with external ref, one with internal ref */}
      {sectionRef ? (
        <motion.h2
          ref={sectionRef}
          initial={{ opacity: 0, y: 20 }}
      ...
      >
        <div className="space-y-6">
          {experiences
            .slice(0, showAll ? experiences.length : showRecent)
